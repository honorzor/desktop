...
public class FourTikNoil implements TikNoli {
    ...
    private void tableStat() {
        ...
        if (lastStep.equals(FourTikNoil.TIC)) {
            countTick++;
        }
        if (lastStep.equals(FourTikNoil.NOLI)) {
            countNoil++;
        }
    ...
    private void appendToWinnersTable(String str) {
        this.winnersTable.clear();
        this.winnersTable.setText(str);
    }
